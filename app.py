...
app.config['MYSQL_PASSWORD'] = 'Mrudul@1234567'
app.config['MYSQL_DB'] = 'mess_db'
mysql = MySQL(app)
...
app.config['MAIL_USERNAME'] = 'mrudulkuchankar@gmail.com'   # your Gmail
app.config['MAIL_PASSWORD'] = 'vijqdrrlfcldvjxl'   # your 16-digit app password
